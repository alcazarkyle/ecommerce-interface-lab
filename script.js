...
let currentUser = {
    name: "KYLE ALCAZAR",
    email: "alcazarkyle282@gmail.com",
    orderHistory: [
...
function addStyles() {
    ...
    style.textContent = `
        ...
        @keyframes highlightFade {
            0% { background-color: rgba(237, 131, 212, 0.5); transform: scale(1); }
